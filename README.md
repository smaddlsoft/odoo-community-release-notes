...
| Part | License |
|---|---|
| Code: everything under `*/tools/` (scripts and the page template) | [AGPL-3.0](LICENSE), as used by OCA tooling |
| Content: data (`*/data/`), summaries, notes, generated pages and our screenshots (`*/img/`) | [CC BY-SA 4.0](LICENSE-CONTENT) |

Not covered by these licenses: the item titles and section names quoted from Odoo's official release notes (© Odoo S.A.,
quoted for reference with a link to the source) and the Odoo name and logos, which are trademarks of Odoo S.A.
Screenshots show Odoo Community (LGPL-3) with its demo data.
