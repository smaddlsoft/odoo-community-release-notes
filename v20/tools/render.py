...
w("## Method\n")
w("The feature list follows the items of Odoo's official release notes. Each item was read and assigned by hand to the module(s) it belongs to. Each module's edition "
